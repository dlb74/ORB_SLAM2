...
namespace ORB_SLAM2
{
    ...
    System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
                   const bool bUseViewer):mSensor(sensor), mpViewer(static_cast<Viewer*>(NULL)), mpViewerDepth(static_cast<Viewer*>(NULL)),
            ...
            mbDeactivateLocalizationMode(false)
    {
        ...
        if(bUseViewer)
        {
            cout<<"bUseViewer"<<endl;
            mpViewer = new Viewer(this, mpFrameDrawer,mpMapDrawer,mpTracker,strSettingsFile);
            mptViewer = new thread(&Viewer::Run, mpViewer);
            mpTracker->SetViewer(mpViewer);

//            mpViewerDepth = new Viewer(this, mpFrameDrawer,mpMapDrawer,mpTracker,strSettingsFile);
//            mptViewerDepth = new thread(&Viewer::Run, mpViewerDepth);
//            mpTracker->SetViewer(mpViewerDepth);
        }
...
//        cout<<"Tcwsize: "<<Tcw.size()<<endl;
    ...
    void System::Shutdown()
    {
        ...
        if(mpViewerDepth)
        {
            mpViewerDepth->RequestFinish();
            while(!mpViewerDepth->isFinished())
                usleep(5000);
        }
